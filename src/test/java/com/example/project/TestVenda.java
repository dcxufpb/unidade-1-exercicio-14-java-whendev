...
public class TestVenda {
    ...
    private Produto produto1 = new Produto(100, "Banana", "cx", 7.45, "ST");
    private Produto produto2 = new Produto(101, "Laranja", "cx", 3.32, "ST");
    private Produto produto3 = new Produto(102, "Leite", "l", 2.15, "");
    private Produto produto4 = new Produto(102, "Leite", "l", 0, "");
